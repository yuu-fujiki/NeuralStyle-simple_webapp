from library.nst_utils import *
from library.download_utils import download_vgg19
import numpy as np
...
class StyleTransfer(object):
    ...
    def fit_and_transform(self, content_image, style_image, output_dir_path, num_iterations=10):
        STYLE_LAYERS = [
            ('conv1_1', 0.2),
            ('conv2_1', 0.2),
            ('conv3_1', 0.2),
